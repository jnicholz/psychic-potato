...
var teamViewModel = {
    ...
    list: {
        ...
        listTitle: "Bending Teams",
       
        id: "my-list",
        tableClasses: "table table-striped table-hover mt-2",   //classes for table tag
        thClasses:"bg-primary bg-gradient text-light",                    //classes for my th tags (you may not need)
